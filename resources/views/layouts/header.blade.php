                    ...
                    <li class="menu-content ps-menu">
                        <a href="#">
                            <div class="message-image">
                                <img src="{{asset('')}}admin/assets/images/avatar1.png" class="rounded-circle w-100" alt="user1">
                            </div>
                        ...
                        <a href="#">
                            <div class="message-image">
                                <img src="{{asset('')}}admin/assets/images/avatar2.png" class="rounded-circle w-100" alt="user1">
                            </div>
